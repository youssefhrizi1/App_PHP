    ...
    <span class="sr-only">N</span>
                	...
                	<nav class="navbar navbar-default">
                        ...
                        <div class="navbar-header">
                          ...
                          <span class="site-description">------Supprimer Articles-------</span>
                        </div>
                    
                        <!-- Collect the nav links, forms, and other content for toggling -->
                        <div class="collapse navbar-collapse" id="mainNav" >
                          <ul class="nav main-menu navbar-nav">
                            <li><a href="affiche_Articles.php"><i class="fa fa-home"></i> Acceuil</a></li>
...
$reponse=$bdd->query("DELETE FROM  articles WHERE  ArticlesID = $vardel");

// 
		echo '<body onLoad="alert(\'Article a ete supprimer avec succes...\')">';
