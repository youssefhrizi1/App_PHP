    ...
    <span class="sr-only">N</span>
                	...
                	<nav class="navbar navbar-default">
                        ...
                        <div class="navbar-header">
                          ...
                          <span class="site-description">Filtrer Agent</span>
                        </div>
...
require('../pages/connectionbd.php');	
	...
	$lesid=	$bdd->query("SELECT * FROM  agent ");
...
<form name="filtrer" action="FiltrerAg.php" method="POST">
<center><h2><b>Filtre </b></h2></center><br>

 <div class="row">
                                 <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
									
									<!--test select list input-->
									<div class="input-group">
                                          <div class="input-group-addon">
                                             <span class="glyphicon glyphicon-lock"></span>
                                          </div>
										  
										   <select class="form-control" id="sel1" name="idagents">
										  <?php
										  
              while($lesidag=$lesid->fetch())
	 {
		
      echo " <option >".$lesidag['id_agent']."</option>";
	 ...
	 ?>
									   ...
									   <div class="input-group">
                                          <div class="input-group-addon">
                                           ...
                                           Exp :<span>2017-11-04</span>
                                          <input type="text" placeholder="Date Debut  ..." name="dtd" class="form-control"  required>
									   ...
									   <div class="input-group">
                                          ...
                                          <input type="text" placeholder="Date Fin..." name="dtf" class="form-control" required>
							   ...
							   <div class="row">
                                 <div class="col-xs-12 col-sm-12 col-md-12">
                                    <button type="submit" class="btn btn-success btn-block btn-lg"  > Filtrer </button>
                                 </div>
                              </div>
</form>
