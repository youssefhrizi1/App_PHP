...
<head>
   <meta charset="utf-8">
    ...
    <title>Profile Header - Bootsnipp.com</title>
    ...
    <span class="sr-only">N</span>
                	...
                	<nav class="navbar navbar-default">
                        ...
                        <div class="navbar-header">
                          ...
                          <span class="site-description">Modifier Agent</span>
                        </div>
...
<form name="enterpwd" action="changepwd.php" method="POST">
<center><h2><b>Entrer nouveau mot de passe</b></h2></center><br>
 ...
 <div class="row">
							   ...
							   <div class="row">
                                 <div class="col-xs-12 col-sm-12 col-md-12">
                                    <button type="submit" class="btn btn-success btn-block btn-lg"  > Changer password agent </button>
                                 </div>
                              </div>
</form>
...
preg_match_all('!\d+!', $upbtn, $upbtn);
//print_r($upbtn);
$varup = implode(' ', $upbtn[0]);
//echo "id btn update  :".$varup;


		// on enregistre les paramètres de notre visiteur comme variables de session ($login et $pwd) (notez bien que l'on utilise pas le $ pour enregistrer ces variables)
		$_SESSION['varup'] = $_POST['update'];
