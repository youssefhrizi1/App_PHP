    ...
    <span class="sr-only">N</span>
                	...
                	<nav class="navbar navbar-default">
                        ...
                        <div class="navbar-header">
                          ...
                          <span class="site-description">Commentaires Agent</span>
                        </div>
...
<form name="entercom" action="addcom.php" method="POST">
<center><h2><b>Commentaires </b></h2></center><br>
 ...
 <div class="row">
                                 <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                       <div class="input-group">
                                          ...
                                          <input type="text" placeholder="Commentaires ..." name="commentaires" class="form-control" >
							   ...
							   <div class="row">
                                 <div class="col-xs-12 col-sm-12 col-md-12">
                                    <button type="submit" class="btn btn-success btn-block btn-lg"  > Ajouter Commentaires  </button>
                                 </div>
                              </div>
</form>
...
<?php
$combtn= $_POST['com'];
//echo "nombre btn :".$combtn;
preg_match_all('!\d+!', $combtn, $combtn);
//print_r($upbtn);
$varup = implode(' ', $combtn[0]);
//echo "id btn commentaires  :".$varup;


		// on enregistre les paramètres de notre visiteur comme variables de session ($login et $pwd) (notez bien que l'on utilise pas le $ pour enregistrer ces variables)
		$_SESSION['varup'] = $_POST['com'];
